...
const SalesDetails = () => {
  ...
  const fetchPropertyDetails = async () => {
    try {
      ...
      // First check if it's a static (featured) property
      const staticProperty = salesData.find(p => p.id === id)
      
      if (staticProperty) {
        setProperty({ ...staticProperty, featured: true, source: 'static' })
      } else {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50 pt-20">
        <div className="text-center p-8">
          <div className="animate-spin rounded-full h-16 w-16 border-b-2 border-[#0078DB] mx-auto mb-4"></div>
  ...
  return (
    <div className="bg-gradient-to-b from-gray-50 to-white min-h-screen pt-16">
      ...
      <div className="max-w-7xl mx-auto px-6 py-4">
        ...
        <div className="mb-6">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 mb-3">
            <div className="flex-1">
              {/* Premium/New Badge */}
              {property.featured && (
                <div className="inline-flex items-center gap-1.5 mb-2 px-3 py-1 bg-gradient-to-r from-amber-500 to-orange-500 text-white text-xs font-semibold rounded-full">
              ...
              {property.isNew && !property.featured && (
                <div className="inline-flex items-center gap-1.5 mb-2 px-3 py-1 bg-green-600 text-white text-xs font-semibold rounded-full">
                  <svg className="w-3 h-3" fill="currentColor" viewBox="0 0 20 20">
        ...
        {/* No Images Message for API Properties */}
        {property.source === 'api' && (!property.images || property.images.length === 0) && (
          <div className="mb-10">
            <div className="bg-gradient-to-r from-amber-50 to-orange-50 border-2 border-amber-200 rounded-xl p-8 text-center">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-2">📷 Photos Coming Soon</h3>
              <p className="text-gray-600 mb-4">Property images will be added shortly. Contact us for more details and site visits!</p>
              <button className="inline-flex items-center gap-2 bg-[#0078DB] text-white px-6 py-2.5 rounded-lg font-semibold hover:bg-[#0066c0] transition-all">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
